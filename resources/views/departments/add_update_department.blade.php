				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow">
                            ...
                            @endif
	            <form   @if(isset($department->id)!="")
                    action="{{route('departmentupdate',$department->id)}}"  @else action="{{route('departmentstore')}}" @endif method="POST">
                                @csrf
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="patient-name">Department Name</label>
										<input type="text"  @if(isset($department->id)!="") value="{{ $department->department_name }}" @endif name="department_name" class="form-control"
                                         placeholder="Department Name" id="patient-id">
									</div>
