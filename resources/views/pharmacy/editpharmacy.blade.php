<x-guest-layout>
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">Edit Pharmacy</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow">
							<h3 class="widget-title">Edit Pharmacy</h3>
							<form>
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input type="date" value="2018-11-12" placeholder="Pharmacy Date" class="form-control" id="Pharmacy-date">
									</div>
									<div class="form-group col-md-6">
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Successfully Updated!</strong> Pharmacy updated
