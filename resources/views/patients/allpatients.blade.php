									...
									<tbody>
										...
										<tr>
                                            ...
                                            {{-- <a href="{{ route('patientedit', $patients->id) }}"><button type="button"
                                                    ...
                                                    EDIT</button></a> --}}
<button type="button" class="btn btn-success mt-3 mb-0 editApp" data-id="{{ $patients->id }}" data-toggle="modal" data-target="#exampleModal">
   ...
   url: '{{ route('getpatientbyid')}}',
      ...
      success:function(response){
        console.log(response);
         $('.modal-body').append('<div class="form-group col-md-6 removedata"><label for="patient-name">Patient Name</label><input type="text" name="patient_name" value="'+response.patient.patient_name+'"/><div class="form-group col-md-6 removedata"><label for="dob">Date Of Birth</label><input type="date" name="patient_date_of_birth" value="'+response.patient.patient_date_of_birth+'"/><div class="form-group col-md-6 removedata"><label for="age">Age</label><input type="text" name="patient_age" value="'+response.patient.patient_age+'"/><div class="form-group col-md-6 removedata"><label for="phone">Phone</label><input type="text" name="patient_phone" value="'+response.patient.patient_phone+'"/><div class="form-group col-md-6 removedata"><label for="email">Email</label><input type="text" name="patient_email" value="'+response.patient.patient_email+'"/><div class="form-group col-md-6 removedata"><label for="address">Address</label><input type="text" name="patient_address" value="'+response.patient.patient_address+'"/><div class="form-group col-md-6 removedata"><label for="file">File</label><input type="file" name="patient_profile" value="'+response.patient.patient_profile+'"/>' );
            }
   });
   });
