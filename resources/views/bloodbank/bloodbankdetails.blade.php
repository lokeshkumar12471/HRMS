<x-guest-layout>
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">BloodBank Details</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">BloodBank Details</li>
					</ol>
				</div>
			</div>
			<!-- /Page Title -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 proclinic-box-shadow">
                            <h3 class="widget-title">BloodBank Details</h3>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><strong>BloodBank Date</strong></td>
                                            <td>16-nov-2018</td>
                                        </tr>
                                        <tr>
