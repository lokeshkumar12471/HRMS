<x-guest-layout>
			...
			<div class="row no-margin-padding">
				<div class="col-md-6">
					<h3 class="block-title">Add BloodBank</h3>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Add BloodBank</li>
					</ol>
				</div>
			</div>
			<!-- /Page Title -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 proclinic-box-shadow">
							<h3 class="widget-title">Add BloodBank</h3>
							<form>
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input type="date" placeholder="BloodBank Date" class="form-control" id="bloodbank-date">
									</div>
									<div class="form-group col-md-6">
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Successfully Done!</strong> BloodBank token Generated
